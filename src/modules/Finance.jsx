...
const EXPENSE_CATS = ["Renta","Servicios (luz, agua, internet)","Materiales y papelería","Suscripciones de software","Formación continua","Publicidad","Honorarios","Otros"];
...
export default function Finance({
  ...
  return (
    <div>
      ...
      {/* ── Tab bar ──────────────────────────────────────────────────────── */}
      <div style={{ display:"flex", gap:0, marginBottom:20, borderBottom:`2px solid ${T.bdrL}` }}>
        {TABS.map(t => {
          ...
          return (
            <button key={t.key} onClick={() => setActiveTab(t.key)}
              style={{ display:"flex", alignItems:"center", gap:6, padding:"10px 16px",
                ...
                color:active?T.p:T.tm, background:"none", border:"none",
                cursor:"pointer", borderBottom:`2px solid ${active?T.p:"transparent"}`,
              ...
              return (
                <button key={s.label} onClick={() => setFilterStatus(active?"":s.filterKey)}
                  style={{ padding:"14px 12px", borderRadius:16, textAlign:"left", cursor:"pointer",
                    ...
                    boxShadow:active?`0 0 0 3px ${s.color}15`:T.sh, transition:"all .15s", minHeight:120 }}>
